...
const PollDetail: React.FC<Param> = ({ data }) => {
  const [selected, setSelected] = useState<string>("Kuro");
    ...
    <div className="w-full flex flex-col justify-center items-center space-y-16">
      <div className="flex flex-col w-full lg:w-[50%] rounded overflow-hidden shadow-lg bg-[#393E46] px-8 py-8">
        ...
        <div className="flex flex-row space-x-4 ">
          ...
          <button className="flex items-center bg-[#393E46] border-[#a6a7a8] border-solid border-2 w-max px-8 py-2 rounded-md mt-6 font-bold hover:bg-gray-500">
