...
function PollingCard<T>() {
	...
	const toggleMultipleOptionSwitch = () =>
		setMulitpleOptionToggle(!mulitpleOptionToggle)
			...
			<div className="flex w-full flex-col gap-6">
				...
				<div className="flex flex-col pt-3 pb-8 w-full">
						...
						<div className="flex flex-col gap-4 w-full md:w-1/2 md:pl-8">
							...
							<div className="flex flex-col">
								...
								>
									...
									<option value="ip_address">One vote per IP Address</option>
									<option value="browser_section">One vote per browser section</option>
								</select>
							</div>
						</div>
					</div>
					...
					<div className="flex w-full items-center space-x-2 pt-6">
						<button className="flex w-full justify-center py-3 bg-blue-500 text-gray-200 rounded-md hover:bg-gray-600 transition font-semibold text-base">
							Create Poll
						</button>
					</div>
				</div>
